...
class FeignNaverErrorDecoderTest {
    ...
    @InjectMocks
    private FeignNaverErrorDecoder feignNaverErrorDecoder;

    @Nested
    @DisplayName("FeignNaverErrorDecoder 의 decode 메소드는")
    class DescribeDecodeInFeignNaverErrorDecoder {
        ...
        class ContextWith500Error {
            ...
            void itReturnNoResponseFromServerException() {
                ...
                Assertions.assertThatThrownBy(() -> feignNaverErrorDecoder.decode(TEST_METHOD_KEY, response))
        ...
        class ContextWith400Error {
            ...
            void setup() {
                ...
                response = Response.builder()
                        ...
                        .body("{\"errorMessage\":\""+ TEST_ERROR_MESSAGE +"\"}", StandardCharsets.UTF_8)
                        .request(request).build();
            }
